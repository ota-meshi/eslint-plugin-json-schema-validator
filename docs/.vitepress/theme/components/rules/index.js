...
const CATEGORY_CLASSES = {
  "json-schema-validator": "eslint-plugin-json-schema-validator-category",
...
for (const k of Object.keys(rules)) {
  ...
  allRules.push({
    classes: "eslint-plugin-json-schema-validator-rule",
    category: "json-schema-validator",
    ruleId: rule.meta.docs.ruleId,
    url: rule.meta.docs.url,
    initChecked: CATEGORY_INDEX["json-schema-validator"] <= 3,
  });
}
